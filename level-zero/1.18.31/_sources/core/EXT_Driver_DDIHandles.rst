...
*Introduced in Level Zero version 1.12*
...
Starting from Level Zero spec version 1.17, support for this extension is **required** for any driver reporting API version 1.17 or later via ``:ref:`zeDriverGetApiVersion`\``.
...
For drivers reporting API version 1.16 or earlier, the loader must continue to check for this extension via ``:ref:`zeDriverGetExtensionProperties`\``
