...
If you are looking for the base oneAPI Specification go here: `oneAPI Spec`_.
oneAPI Level Zero is at this site. All other specs have been archived.
For any questions, file an issue at `level-zero-spec issues`_.
