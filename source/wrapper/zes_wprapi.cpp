...
namespace zes
{
    ...
    {
        zes_sysman_handle_t hSysman;

        auto result = static_cast<result_t>( ::zesSysmanGet(
            reinterpret_cast<zes_device_handle_t>( pDevice->getHandle() ),
            static_cast<zes_sysman_version_t>( version ),
            &hSysman ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::Sysman::Get" );
        ...
        catch( std::bad_alloc& )
        {
            ...
            throw exception_t( result_t::ERROR_OUT_OF_HOST_MEMORY, __FILE__, ZE_STRING(__LINE__), "zes::Sysman::Get" );
        }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanDeviceGetProperties(
            reinterpret_cast<zes_sysman_handle_t>( getHandle() ),
            reinterpret_cast<zes_sysman_properties_t*>( pProperties ) ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::Sysman::DeviceGetProperties" );
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanDeviceGetState(
            reinterpret_cast<zes_sysman_handle_t>( getHandle() ),
            reinterpret_cast<zes_sysman_state_t*>( pState ) ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::Sysman::DeviceGetState" );
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanDeviceReset(
            reinterpret_cast<zes_sysman_handle_t>( getHandle() ),
            static_cast<ze_bool_t>( force ) ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::Sysman::DeviceReset" );
    }
    ...
    {
        thread_local std::vector<zes_sysman_sched_handle_t> hScheduler;
        hScheduler.resize( ( ppScheduler ) ? *pCount : 0 );

        auto result = static_cast<result_t>( ::zesSysmanSchedulerGet(
            reinterpret_cast<zes_sysman_handle_t>( getHandle() ),
            pCount,
            hScheduler.data() ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::Sysman::SchedulerGet" );
        ...
        catch( std::bad_alloc& )
        {
            ...
            throw exception_t( result_t::ERROR_OUT_OF_HOST_MEMORY, __FILE__, ZE_STRING(__LINE__), "zes::Sysman::SchedulerGet" );
        }
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanSchedulerGetProperties(
            reinterpret_cast<zes_sysman_sched_handle_t>( getHandle() ),
            reinterpret_cast<zes_sched_properties_t*>( pProperties ) ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanScheduler::GetProperties" );
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanSchedulerGetCurrentMode(
            reinterpret_cast<zes_sysman_sched_handle_t>( getHandle() ),
            reinterpret_cast<zes_sched_mode_t*>( pMode ) ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanScheduler::GetCurrentMode" );
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanSchedulerGetTimeoutModeProperties(
            reinterpret_cast<zes_sysman_sched_handle_t>( getHandle() ),
            static_cast<ze_bool_t>( getDefaults ),
            reinterpret_cast<zes_sched_timeout_properties_t*>( pConfig ) ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanScheduler::GetTimeoutModeProperties" );
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanSchedulerGetTimesliceModeProperties(
            reinterpret_cast<zes_sysman_sched_handle_t>( getHandle() ),
            static_cast<ze_bool_t>( getDefaults ),
            reinterpret_cast<zes_sched_timeslice_properties_t*>( pConfig ) ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanScheduler::GetTimesliceModeProperties" );
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanSchedulerSetTimeoutMode(
            reinterpret_cast<zes_sysman_sched_handle_t>( getHandle() ),
            reinterpret_cast<zes_sched_timeout_properties_t*>( pProperties ),
            reinterpret_cast<ze_bool_t*>( pNeedReload ) ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanScheduler::SetTimeoutMode" );
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanSchedulerSetTimesliceMode(
            reinterpret_cast<zes_sysman_sched_handle_t>( getHandle() ),
            reinterpret_cast<zes_sched_timeslice_properties_t*>( pProperties ),
            reinterpret_cast<ze_bool_t*>( pNeedReload ) ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanScheduler::SetTimesliceMode" );
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanSchedulerSetExclusiveMode(
            reinterpret_cast<zes_sysman_sched_handle_t>( getHandle() ),
            reinterpret_cast<ze_bool_t*>( pNeedReload ) ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanScheduler::SetExclusiveMode" );
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanSchedulerSetComputeUnitDebugMode(
            reinterpret_cast<zes_sysman_sched_handle_t>( getHandle() ),
            reinterpret_cast<ze_bool_t*>( pNeedReload ) ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanScheduler::SetComputeUnitDebugMode" );
    }
    ...
    {
        thread_local std::vector<zes_sysman_perf_handle_t> hPerf;
        hPerf.resize( ( ppPerf ) ? *pCount : 0 );

        auto result = static_cast<result_t>( ::zesSysmanPerformanceFactorGet(
            reinterpret_cast<zes_sysman_handle_t>( getHandle() ),
            pCount,
            hPerf.data() ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::Sysman::PerformanceFactorGet" );
        ...
        catch( std::bad_alloc& )
        {
            ...
            throw exception_t( result_t::ERROR_OUT_OF_HOST_MEMORY, __FILE__, ZE_STRING(__LINE__), "zes::Sysman::PerformanceFactorGet" );
        }
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanPerformanceFactorGetProperties(
            reinterpret_cast<zes_sysman_perf_handle_t>( getHandle() ),
            reinterpret_cast<zes_perf_properties_t*>( pProperties ) ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanPerformanceFactor::GetProperties" );
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanPerformanceFactorGetConfig(
            reinterpret_cast<zes_sysman_perf_handle_t>( getHandle() ),
            pFactor ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanPerformanceFactor::GetConfig" );
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanPerformanceFactorSetConfig(
            reinterpret_cast<zes_sysman_perf_handle_t>( getHandle() ),
            factor ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanPerformanceFactor::SetConfig" );
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanProcessesGetState(
            reinterpret_cast<zes_sysman_handle_t>( getHandle() ),
            pCount,
            reinterpret_cast<zes_process_state_t*>( pProcesses ) ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::Sysman::ProcessesGetState" );
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanPciGetProperties(
            reinterpret_cast<zes_sysman_handle_t>( getHandle() ),
            reinterpret_cast<zes_pci_properties_t*>( pProperties ) ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::Sysman::PciGetProperties" );
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanPciGetState(
            reinterpret_cast<zes_sysman_handle_t>( getHandle() ),
            reinterpret_cast<zes_pci_state_t*>( pState ) ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::Sysman::PciGetState" );
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanPciGetBars(
            reinterpret_cast<zes_sysman_handle_t>( getHandle() ),
            pCount,
            reinterpret_cast<zes_pci_bar_properties_t*>( pProperties ) ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::Sysman::PciGetBars" );
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanPciGetStats(
            reinterpret_cast<zes_sysman_handle_t>( getHandle() ),
            reinterpret_cast<zes_pci_stats_t*>( pStats ) ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::Sysman::PciGetStats" );
    }
    ...
    {
        thread_local std::vector<zes_sysman_pwr_handle_t> hPower;
        hPower.resize( ( ppPower ) ? *pCount : 0 );

        auto result = static_cast<result_t>( ::zesSysmanPowerGet(
            reinterpret_cast<zes_sysman_handle_t>( getHandle() ),
            pCount,
            hPower.data() ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::Sysman::PowerGet" );
        ...
        catch( std::bad_alloc& )
        {
            ...
            throw exception_t( result_t::ERROR_OUT_OF_HOST_MEMORY, __FILE__, ZE_STRING(__LINE__), "zes::Sysman::PowerGet" );
        }
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanPowerGetProperties(
            reinterpret_cast<zes_sysman_pwr_handle_t>( getHandle() ),
            reinterpret_cast<zes_power_properties_t*>( pProperties ) ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanPower::GetProperties" );
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanPowerGetEnergyCounter(
            reinterpret_cast<zes_sysman_pwr_handle_t>( getHandle() ),
            reinterpret_cast<zes_power_energy_counter_t*>( pEnergy ) ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanPower::GetEnergyCounter" );
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanPowerGetLimits(
            reinterpret_cast<zes_sysman_pwr_handle_t>( getHandle() ),
        ...
        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanPower::GetLimits" );
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanPowerSetLimits(
            reinterpret_cast<zes_sysman_pwr_handle_t>( getHandle() ),
        ...
        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanPower::SetLimits" );
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanPowerGetEnergyThreshold(
            reinterpret_cast<zes_sysman_pwr_handle_t>( getHandle() ),
            reinterpret_cast<zes_energy_threshold_t*>( pThreshold ) ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanPower::GetEnergyThreshold" );
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanPowerSetEnergyThreshold(
            reinterpret_cast<zes_sysman_pwr_handle_t>( getHandle() ),
            threshold ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanPower::SetEnergyThreshold" );
    }
    ...
    {
        thread_local std::vector<zes_sysman_freq_handle_t> hFrequency;
        hFrequency.resize( ( ppFrequency ) ? *pCount : 0 );

        auto result = static_cast<result_t>( ::zesSysmanFrequencyGet(
            reinterpret_cast<zes_sysman_handle_t>( getHandle() ),
            pCount,
            hFrequency.data() ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::Sysman::FrequencyGet" );
        ...
        catch( std::bad_alloc& )
        {
            ...
            throw exception_t( result_t::ERROR_OUT_OF_HOST_MEMORY, __FILE__, ZE_STRING(__LINE__), "zes::Sysman::FrequencyGet" );
        }
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanFrequencyGetProperties(
            reinterpret_cast<zes_sysman_freq_handle_t>( getHandle() ),
            reinterpret_cast<zes_freq_properties_t*>( pProperties ) ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanFrequency::GetProperties" );
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanFrequencyGetAvailableClocks(
            reinterpret_cast<zes_sysman_freq_handle_t>( getHandle() ),
            pCount,
            phFrequency ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanFrequency::GetAvailableClocks" );
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanFrequencyGetRange(
            reinterpret_cast<zes_sysman_freq_handle_t>( getHandle() ),
            reinterpret_cast<zes_freq_range_t*>( pLimits ) ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanFrequency::GetRange" );
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanFrequencySetRange(
            reinterpret_cast<zes_sysman_freq_handle_t>( getHandle() ),
            reinterpret_cast<const zes_freq_range_t*>( pLimits ) ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanFrequency::SetRange" );
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanFrequencyGetState(
            reinterpret_cast<zes_sysman_freq_handle_t>( getHandle() ),
            reinterpret_cast<zes_freq_state_t*>( pState ) ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanFrequency::GetState" );
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanFrequencyGetThrottleTime(
            reinterpret_cast<zes_sysman_freq_handle_t>( getHandle() ),
            reinterpret_cast<zes_freq_throttle_time_t*>( pThrottleTime ) ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanFrequency::GetThrottleTime" );
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanFrequencyOcGetCapabilities(
            reinterpret_cast<zes_sysman_freq_handle_t>( getHandle() ),
            reinterpret_cast<zes_oc_capabilities_t*>( pOcCapabilities ) ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanFrequency::OcGetCapabilities" );
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanFrequencyOcGetConfig(
            reinterpret_cast<zes_sysman_freq_handle_t>( getHandle() ),
            reinterpret_cast<zes_oc_config_t*>( pOcConfiguration ) ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanFrequency::OcGetConfig" );
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanFrequencyOcSetConfig(
            reinterpret_cast<zes_sysman_freq_handle_t>( getHandle() ),
            reinterpret_cast<zes_oc_config_t*>( pOcConfiguration ),
            reinterpret_cast<ze_bool_t*>( pDeviceRestart ) ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanFrequency::OcSetConfig" );
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanFrequencyOcGetIccMax(
            reinterpret_cast<zes_sysman_freq_handle_t>( getHandle() ),
            pOcIccMax ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanFrequency::OcGetIccMax" );
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanFrequencyOcSetIccMax(
            reinterpret_cast<zes_sysman_freq_handle_t>( getHandle() ),
            ocIccMax ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanFrequency::OcSetIccMax" );
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanFrequencyOcGetTjMax(
            reinterpret_cast<zes_sysman_freq_handle_t>( getHandle() ),
            pOcTjMax ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanFrequency::OcGetTjMax" );
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanFrequencyOcSetTjMax(
            reinterpret_cast<zes_sysman_freq_handle_t>( getHandle() ),
            ocTjMax ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanFrequency::OcSetTjMax" );
    }
    ...
    {
        thread_local std::vector<zes_sysman_engine_handle_t> hEngine;
        hEngine.resize( ( ppEngine ) ? *pCount : 0 );

        auto result = static_cast<result_t>( ::zesSysmanEngineGet(
            reinterpret_cast<zes_sysman_handle_t>( getHandle() ),
            pCount,
            hEngine.data() ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::Sysman::EngineGet" );
        ...
        catch( std::bad_alloc& )
        {
            ...
            throw exception_t( result_t::ERROR_OUT_OF_HOST_MEMORY, __FILE__, ZE_STRING(__LINE__), "zes::Sysman::EngineGet" );
        }
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanEngineGetProperties(
            reinterpret_cast<zes_sysman_engine_handle_t>( getHandle() ),
            reinterpret_cast<zes_engine_properties_t*>( pProperties ) ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanEngine::GetProperties" );
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanEngineGetActivity(
            reinterpret_cast<zes_sysman_engine_handle_t>( getHandle() ),
            reinterpret_cast<zes_engine_stats_t*>( pStats ) ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanEngine::GetActivity" );
    }
    ...
    {
        thread_local std::vector<zes_sysman_standby_handle_t> hStandby;
        hStandby.resize( ( ppStandby ) ? *pCount : 0 );

        auto result = static_cast<result_t>( ::zesSysmanStandbyGet(
            reinterpret_cast<zes_sysman_handle_t>( getHandle() ),
            pCount,
            hStandby.data() ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::Sysman::StandbyGet" );
        ...
        catch( std::bad_alloc& )
        {
            ...
            throw exception_t( result_t::ERROR_OUT_OF_HOST_MEMORY, __FILE__, ZE_STRING(__LINE__), "zes::Sysman::StandbyGet" );
        }
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanStandbyGetProperties(
            reinterpret_cast<zes_sysman_standby_handle_t>( getHandle() ),
            reinterpret_cast<zes_standby_properties_t*>( pProperties ) ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanStandby::GetProperties" );
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanStandbyGetMode(
            reinterpret_cast<zes_sysman_standby_handle_t>( getHandle() ),
            reinterpret_cast<zes_standby_promo_mode_t*>( pMode ) ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanStandby::GetMode" );
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanStandbySetMode(
            reinterpret_cast<zes_sysman_standby_handle_t>( getHandle() ),
            static_cast<zes_standby_promo_mode_t>( mode ) ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanStandby::SetMode" );
    }
    ...
    {
        thread_local std::vector<zes_sysman_firmware_handle_t> hFirmware;
        hFirmware.resize( ( ppFirmware ) ? *pCount : 0 );

        auto result = static_cast<result_t>( ::zesSysmanFirmwareGet(
            reinterpret_cast<zes_sysman_handle_t>( getHandle() ),
            pCount,
            hFirmware.data() ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::Sysman::FirmwareGet" );
        ...
        catch( std::bad_alloc& )
        {
            ...
            throw exception_t( result_t::ERROR_OUT_OF_HOST_MEMORY, __FILE__, ZE_STRING(__LINE__), "zes::Sysman::FirmwareGet" );
        }
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanFirmwareGetProperties(
            reinterpret_cast<zes_sysman_firmware_handle_t>( getHandle() ),
            reinterpret_cast<zes_firmware_properties_t*>( pProperties ) ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanFirmware::GetProperties" );
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanFirmwareGetChecksum(
            reinterpret_cast<zes_sysman_firmware_handle_t>( getHandle() ),
            pChecksum ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanFirmware::GetChecksum" );
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanFirmwareFlash(
            reinterpret_cast<zes_sysman_firmware_handle_t>( getHandle() ),
            pImage,
            size ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanFirmware::Flash" );
    }
    ...
    {
        thread_local std::vector<zes_sysman_mem_handle_t> hMemory;
        hMemory.resize( ( ppMemory ) ? *pCount : 0 );

        auto result = static_cast<result_t>( ::zesSysmanMemoryGet(
            reinterpret_cast<zes_sysman_handle_t>( getHandle() ),
            pCount,
            hMemory.data() ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::Sysman::MemoryGet" );
        ...
        catch( std::bad_alloc& )
        {
            ...
            throw exception_t( result_t::ERROR_OUT_OF_HOST_MEMORY, __FILE__, ZE_STRING(__LINE__), "zes::Sysman::MemoryGet" );
        }
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanMemoryGetProperties(
            reinterpret_cast<zes_sysman_mem_handle_t>( getHandle() ),
            reinterpret_cast<zes_mem_properties_t*>( pProperties ) ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanMemory::GetProperties" );
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanMemoryGetState(
            reinterpret_cast<zes_sysman_mem_handle_t>( getHandle() ),
            reinterpret_cast<zes_mem_state_t*>( pState ) ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanMemory::GetState" );
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanMemoryGetBandwidth(
            reinterpret_cast<zes_sysman_mem_handle_t>( getHandle() ),
            reinterpret_cast<zes_mem_bandwidth_t*>( pBandwidth ) ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanMemory::GetBandwidth" );
    }
    ...
    {
        thread_local std::vector<zes_sysman_fabric_port_handle_t> hPort;
        hPort.resize( ( ppPort ) ? *pCount : 0 );

        auto result = static_cast<result_t>( ::zesSysmanFabricPortGet(
            reinterpret_cast<zes_sysman_handle_t>( getHandle() ),
            pCount,
            hPort.data() ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::Sysman::FabricPortGet" );
        ...
        catch( std::bad_alloc& )
        {
            ...
            throw exception_t( result_t::ERROR_OUT_OF_HOST_MEMORY, __FILE__, ZE_STRING(__LINE__), "zes::Sysman::FabricPortGet" );
        }
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanFabricPortGetProperties(
            reinterpret_cast<zes_sysman_fabric_port_handle_t>( getHandle() ),
            reinterpret_cast<zes_fabric_port_properties_t*>( pProperties ) ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanFabricPort::GetProperties" );
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanFabricPortGetLinkType(
            reinterpret_cast<zes_sysman_fabric_port_handle_t>( getHandle() ),
            static_cast<ze_bool_t>( verbose ),
            reinterpret_cast<zes_fabric_link_type_t*>( pLinkType ) ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanFabricPort::GetLinkType" );
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanFabricPortGetConfig(
            reinterpret_cast<zes_sysman_fabric_port_handle_t>( getHandle() ),
            reinterpret_cast<zes_fabric_port_config_t*>( pConfig ) ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanFabricPort::GetConfig" );
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanFabricPortSetConfig(
            reinterpret_cast<zes_sysman_fabric_port_handle_t>( getHandle() ),
            reinterpret_cast<const zes_fabric_port_config_t*>( pConfig ) ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanFabricPort::SetConfig" );
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanFabricPortGetState(
            reinterpret_cast<zes_sysman_fabric_port_handle_t>( getHandle() ),
            reinterpret_cast<zes_fabric_port_state_t*>( pState ) ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanFabricPort::GetState" );
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanFabricPortGetThroughput(
            reinterpret_cast<zes_sysman_fabric_port_handle_t>( getHandle() ),
            reinterpret_cast<zes_fabric_port_throughput_t*>( pThroughput ) ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanFabricPort::GetThroughput" );
    }
    ...
    {
        thread_local std::vector<zes_sysman_temp_handle_t> hTemperature;
        hTemperature.resize( ( ppTemperature ) ? *pCount : 0 );

        auto result = static_cast<result_t>( ::zesSysmanTemperatureGet(
            reinterpret_cast<zes_sysman_handle_t>( getHandle() ),
            pCount,
            hTemperature.data() ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::Sysman::TemperatureGet" );
        ...
        catch( std::bad_alloc& )
        {
            ...
            throw exception_t( result_t::ERROR_OUT_OF_HOST_MEMORY, __FILE__, ZE_STRING(__LINE__), "zes::Sysman::TemperatureGet" );
        }
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanTemperatureGetProperties(
            reinterpret_cast<zes_sysman_temp_handle_t>( getHandle() ),
            reinterpret_cast<zes_temp_properties_t*>( pProperties ) ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanTemperature::GetProperties" );
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanTemperatureGetConfig(
            reinterpret_cast<zes_sysman_temp_handle_t>( getHandle() ),
            reinterpret_cast<zes_temp_config_t*>( pConfig ) ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanTemperature::GetConfig" );
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanTemperatureSetConfig(
            reinterpret_cast<zes_sysman_temp_handle_t>( getHandle() ),
            reinterpret_cast<const zes_temp_config_t*>( pConfig ) ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanTemperature::SetConfig" );
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanTemperatureGetState(
            reinterpret_cast<zes_sysman_temp_handle_t>( getHandle() ),
            pTemperature ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanTemperature::GetState" );
    }
    ...
    {
        thread_local std::vector<zes_sysman_psu_handle_t> hPsu;
        hPsu.resize( ( ppPsu ) ? *pCount : 0 );

        auto result = static_cast<result_t>( ::zesSysmanPsuGet(
            reinterpret_cast<zes_sysman_handle_t>( getHandle() ),
            pCount,
            hPsu.data() ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::Sysman::PsuGet" );
        ...
        catch( std::bad_alloc& )
        {
            ...
            throw exception_t( result_t::ERROR_OUT_OF_HOST_MEMORY, __FILE__, ZE_STRING(__LINE__), "zes::Sysman::PsuGet" );
        }
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanPsuGetProperties(
            reinterpret_cast<zes_sysman_psu_handle_t>( getHandle() ),
            reinterpret_cast<zes_psu_properties_t*>( pProperties ) ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanPsu::GetProperties" );
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanPsuGetState(
            reinterpret_cast<zes_sysman_psu_handle_t>( getHandle() ),
            reinterpret_cast<zes_psu_state_t*>( pState ) ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanPsu::GetState" );
    }
    ...
    {
        thread_local std::vector<zes_sysman_fan_handle_t> hFan;
        hFan.resize( ( ppFan ) ? *pCount : 0 );

        auto result = static_cast<result_t>( ::zesSysmanFanGet(
            reinterpret_cast<zes_sysman_handle_t>( getHandle() ),
            pCount,
            hFan.data() ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::Sysman::FanGet" );
        ...
        catch( std::bad_alloc& )
        {
            ...
            throw exception_t( result_t::ERROR_OUT_OF_HOST_MEMORY, __FILE__, ZE_STRING(__LINE__), "zes::Sysman::FanGet" );
        }
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanFanGetProperties(
            reinterpret_cast<zes_sysman_fan_handle_t>( getHandle() ),
            reinterpret_cast<zes_fan_properties_t*>( pProperties ) ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanFan::GetProperties" );
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanFanGetConfig(
            reinterpret_cast<zes_sysman_fan_handle_t>( getHandle() ),
            reinterpret_cast<zes_fan_config_t*>( pConfig ) ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanFan::GetConfig" );
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanFanSetConfig(
            reinterpret_cast<zes_sysman_fan_handle_t>( getHandle() ),
            reinterpret_cast<const zes_fan_config_t*>( pConfig ) ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanFan::SetConfig" );
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanFanGetState(
            reinterpret_cast<zes_sysman_fan_handle_t>( getHandle() ),
            static_cast<zes_fan_speed_units_t>( units ),
            pSpeed ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanFan::GetState" );
    }
    ...
    {
        thread_local std::vector<zes_sysman_led_handle_t> hLed;
        hLed.resize( ( ppLed ) ? *pCount : 0 );

        auto result = static_cast<result_t>( ::zesSysmanLedGet(
            reinterpret_cast<zes_sysman_handle_t>( getHandle() ),
            pCount,
            hLed.data() ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::Sysman::LedGet" );
        ...
        catch( std::bad_alloc& )
        {
            ...
            throw exception_t( result_t::ERROR_OUT_OF_HOST_MEMORY, __FILE__, ZE_STRING(__LINE__), "zes::Sysman::LedGet" );
        }
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanLedGetProperties(
            reinterpret_cast<zes_sysman_led_handle_t>( getHandle() ),
            reinterpret_cast<zes_led_properties_t*>( pProperties ) ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanLed::GetProperties" );
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanLedGetState(
            reinterpret_cast<zes_sysman_led_handle_t>( getHandle() ),
            reinterpret_cast<zes_led_state_t*>( pState ) ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanLed::GetState" );
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanLedSetState(
            reinterpret_cast<zes_sysman_led_handle_t>( getHandle() ),
            reinterpret_cast<const zes_led_state_t*>( pState ) ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanLed::SetState" );
    }
    ...
    {
        thread_local std::vector<zes_sysman_ras_handle_t> hRas;
        hRas.resize( ( ppRas ) ? *pCount : 0 );

        auto result = static_cast<result_t>( ::zesSysmanRasGet(
            reinterpret_cast<zes_sysman_handle_t>( getHandle() ),
            pCount,
            hRas.data() ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::Sysman::RasGet" );
        ...
        catch( std::bad_alloc& )
        {
            ...
            throw exception_t( result_t::ERROR_OUT_OF_HOST_MEMORY, __FILE__, ZE_STRING(__LINE__), "zes::Sysman::RasGet" );
        }
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanRasGetProperties(
            reinterpret_cast<zes_sysman_ras_handle_t>( getHandle() ),
            reinterpret_cast<zes_ras_properties_t*>( pProperties ) ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanRas::GetProperties" );
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanRasGetConfig(
            reinterpret_cast<zes_sysman_ras_handle_t>( getHandle() ),
            reinterpret_cast<zes_ras_config_t*>( pConfig ) ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanRas::GetConfig" );
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanRasSetConfig(
            reinterpret_cast<zes_sysman_ras_handle_t>( getHandle() ),
            reinterpret_cast<const zes_ras_config_t*>( pConfig ) ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanRas::SetConfig" );
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanRasGetState(
            reinterpret_cast<zes_sysman_ras_handle_t>( getHandle() ),
        ...
        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanRas::GetState" );
    }
    ...
    {
        zes_sysman_event_handle_t hEvent;

        auto result = static_cast<result_t>( ::zesSysmanEventGet(
            reinterpret_cast<zes_sysman_handle_t>( getHandle() ),
            &hEvent ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::Sysman::EventGet" );
        ...
        catch( std::bad_alloc& )
        {
            ...
            throw exception_t( result_t::ERROR_OUT_OF_HOST_MEMORY, __FILE__, ZE_STRING(__LINE__), "zes::Sysman::EventGet" );
        }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanEventGetConfig(
            reinterpret_cast<zes_sysman_event_handle_t>( getHandle() ),
            reinterpret_cast<zes_event_config_t*>( pConfig ) ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanEvent::GetConfig" );
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanEventSetConfig(
            reinterpret_cast<zes_sysman_event_handle_t>( getHandle() ),
            reinterpret_cast<const zes_event_config_t*>( pConfig ) ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanEvent::SetConfig" );
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanEventGetState(
            reinterpret_cast<zes_sysman_event_handle_t>( getHandle() ),
            static_cast<ze_bool_t>( clear ),
            pEvents ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanEvent::GetState" );
    }
    ...
    {
        thread_local std::vector<zes_sysman_event_handle_t> hEvents;
        hEvents.resize( 0 );
        hEvents.reserve( count );
        for( uint32_t i = 0; i < count; ++i )
            hEvents.emplace_back( reinterpret_cast<zes_sysman_event_handle_t>( ppEvents[ i ]->getHandle() ) );

        auto result = static_cast<result_t>( ::zesSysmanEventListen(
        ...
        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanEvent::Listen" );
    }
    ...
    {
        thread_local std::vector<zes_sysman_diag_handle_t> hDiagnostics;
        hDiagnostics.resize( ( ppDiagnostics ) ? *pCount : 0 );

        auto result = static_cast<result_t>( ::zesSysmanDiagnosticsGet(
            reinterpret_cast<zes_sysman_handle_t>( getHandle() ),
            pCount,
            hDiagnostics.data() ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::Sysman::DiagnosticsGet" );
        ...
        catch( std::bad_alloc& )
        {
            ...
            throw exception_t( result_t::ERROR_OUT_OF_HOST_MEMORY, __FILE__, ZE_STRING(__LINE__), "zes::Sysman::DiagnosticsGet" );
        }
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanDiagnosticsGetProperties(
            reinterpret_cast<zes_sysman_diag_handle_t>( getHandle() ),
            reinterpret_cast<zes_diag_properties_t*>( pProperties ) ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanDiagnostics::GetProperties" );
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanDiagnosticsGetTests(
            reinterpret_cast<zes_sysman_diag_handle_t>( getHandle() ),
            pCount,
            reinterpret_cast<zes_diag_test_t*>( pTests ) ) );

        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanDiagnostics::GetTests" );
    }
    ...
    {
        auto result = static_cast<result_t>( ::zesSysmanDiagnosticsRunTests(
            reinterpret_cast<zes_sysman_diag_handle_t>( getHandle() ),
            start,
            end,
        ...
        if( result_t::SUCCESS != result )
            throw exception_t( result, __FILE__, ZE_STRING(__LINE__), "zes::SysmanDiagnostics::RunTests" );
    }
