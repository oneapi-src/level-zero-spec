...
struct ImageCoreFamily : public ImageImp {
    ...
    const SURFACE_FORMAT format_table[XE_IMAGE_FORMAT_MAX + 1][XE_NUMCHANNELS_MAX + 1 - XE_NUMCHANNELS_MIN] = {
        ...
        {RENDER_SURFACE_STATE::SURFACE_FORMAT_R8_UNORM, //XE_IMAGE_FORMAT_UNORM8
         RENDER_SURFACE_STATE::SURFACE_FORMAT_R8G8_UNORM,
         RENDER_SURFACE_STATE::SURFACE_FORMAT_R8G8B8_UNORM,
         RENDER_SURFACE_STATE::SURFACE_FORMAT_R8G8B8A8_UNORM},
        {RENDER_SURFACE_STATE::SURFACE_FORMAT_R8_UNORM, //XE_IMAGE_FORMAT_UNORM8
         RENDER_SURFACE_STATE::SURFACE_FORMAT_R8G8_UNORM,
         RENDER_SURFACE_STATE::SURFACE_FORMAT_R8G8B8_UNORM,
         RENDER_SURFACE_STATE::SURFACE_FORMAT_R8G8B8A8_UNORM},
        {RENDER_SURFACE_STATE::SURFACE_FORMAT_R32_UNORM, //XE_IMAGE_FORMAT_UNORM32
         RENDER_SURFACE_STATE::SURFACE_FORMAT_R32G32_UNORM,
         RENDER_SURFACE_STATE::SURFACE_FORMAT_R32G32B32_UNORM,
         RENDER_SURFACE_STATE::SURFACE_FORMAT_R32G32B32A32_UNORM},

        {RENDER_SURFACE_STATE::SURFACE_FORMAT_R8_SNORM, //XE_IMAGE_FORMAT_SNORM8
         RENDER_SURFACE_STATE::SURFACE_FORMAT_R8G8_SNORM,
         RENDER_SURFACE_STATE::SURFACE_FORMAT_R8G8B8_SNORM,
         RENDER_SURFACE_STATE::SURFACE_FORMAT_R8G8B8A8_SNORM},
        {RENDER_SURFACE_STATE::SURFACE_FORMAT_R8_SNORM, //XE_IMAGE_FORMAT_SNORM8
         RENDER_SURFACE_STATE::SURFACE_FORMAT_R8G8_SNORM,
         RENDER_SURFACE_STATE::SURFACE_FORMAT_R8G8B8_SNORM,
         RENDER_SURFACE_STATE::SURFACE_FORMAT_R8G8B8A8_SNORM},
        {RENDER_SURFACE_STATE::SURFACE_FORMAT_R32_SNORM, //XE_IMAGE_FORMAT_SNORM32
         RENDER_SURFACE_STATE::SURFACE_FORMAT_R32G32_SNORM,
         RENDER_SURFACE_STATE::SURFACE_FORMAT_R32G32B32_SNORM,
         RENDER_SURFACE_STATE::SURFACE_FORMAT_R32G32B32A32_SNORM},
