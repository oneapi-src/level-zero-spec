...
```c
    ...
    // Append a barrier into a command list to ensure hFunction1 memory writes are fully coherent before hFunction2 begins
    ${x}CommandListAppendMemoryBarrier(hCommandList, 1, &size, &ptr, hEvent2, 1, &hEvent1);
