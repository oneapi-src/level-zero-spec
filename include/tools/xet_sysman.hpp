...
namespace xet
{
    ...
    using string_property_t = xet_board_prop_serial_number_t;
    ...
    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Data for the property ::XET_DEVICE_PROP_BRAND
    using string_property_t = xet_device_prop_brand_t;

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Data for the property ::XET_DEVICE_PROP_MODEL
    using string_property_t = xet_device_prop_model_t;

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Data for the property ::XET_DEVICE_PROP_DEVICEID
    using string_property_t = xet_device_prop_deviceid_t;

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Data for the property ::XET_DEVICE_PROP_VENDOR_NAME
    using string_property_t = xet_device_prop_vendor_name_t;

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Data for the property ::XET_DEVICE_PROP_DRIVER_VERSION
    using string_property_t = xet_device_prop_driver_version_t;

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Data for the property ::XET_DEVICE_PROP_COLD_SHUTDOWN
    using xe::bool_t = xet_device_prop_driver_cold_shutdown_t;

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Data for the property ::XET_DEVICE_PROP_COLD_RESET
    using xe::bool_t = xet_device_prop_driver_cold_reset_t;

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Data for the property ::XET_PSU_PROP_AMP_LIMIT
    using uint32_t = xet_psu_prop_amp_limit_t;

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Data for the property ::XET_PSU_PROP_VOLTAGE_STATUS
    using psu_voltage_status_t = xet_psu_prop_voltage_status_t;

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Data for the property ::XET_PSU_PROP_FAN_FAILURE
    using xe::bool_t = xet_psu_prop_fan_failure_t;

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Data for the property ::XET_PSU_PROP_TEMPERATURE
    using uint32_t = xet_psu_prop_temperature_t;

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Data for the property ::XET_PSU_PROP_AMPS
    using uint32_t = xet_psu_prop_amps_t;

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Data for the property ::XET_FAN_PROP_MAX_RPM
    using uint32_t = xet_fan_prop_max_rpm_t;

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Data for the property ::XET_FAN_PROP_MAX_TABLE_SIZE
    using uint32_t = xet_fan_prop_max_table_size_t;

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Data for the property ::XET_FAN_PROP_SPEED_RPM
    using uint32_t = xet_fan_prop_speed_rpm_t;

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Data for the property ::XET_FAN_PROP_SPEED_PERCENT
    using uint32_t = xet_fan_prop_speed_percent_t;

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Data for the property ::XET_FAN_PROP_MODE
    using fan_speed_mode_t = xet_fan_prop_mode_t;

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Data for the property ::XET_FAN_PROP_FIXED_SPEED
    using fan_speed_t = xet_fan_prop_fixed_speed_t;

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Data for the property ::XET_LED_PROP_RGB_CAP
    using xe::bool_t = xet_led_prop_rgb_cap_t;

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Data for the property ::XET_LED_PROP_STATE
    using led_state_t = xet_led_prop_state_t;

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Data for the property ::XET_FIRMWARE_PROP_NAME
    using string_property_t = xet_firmware_prop_name_t;

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Data for the property ::XET_FIRMWARE_PROP_VERSION
    using string_property_t = xet_firmware_prop_version_t;
    ...
    using uint64_t = xet_pwr_prop_accel_assets_t;
    ...
    using uint32_t = xet_pwr_prop_max_limit_t;
    ...
    using uint64_t = xet_pwr_prop_energy_counter_t;
    ...
    /// @details
    ///     - Bitfield of (1<<::xet_accel_asset_t)
    using uint64_t = xet_freq_prop_accel_assets_t;

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Data for the property ::XET_FREQ_PROP_DOMAIN_TYPE
    using freq_domain_type_t = xet_freq_prop_domain_type_t;

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Data for the property ::XET_FREQ_PROP_SRC_FREQ
    using resource_uuid_t = xet_freq_prop_src_freq_t;

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Data for the property ::XET_FREQ_PROP_DVFS_MODE
    using dvfs_mode_t = xet_freq_prop_dvfs_mode_t;

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Data for the property ::XET_FREQ_PROP_FREQ_RANGE
    using freq_range_t = xet_freq_prop_freq_range_t;
    ...
    /// @details
    ///     - In units of MHz
    using uint32_t = xet_freq_prop_freq_tdp_t;
    ...
    /// @details
    ///     - In units of MHz
    using uint32_t = xet_freq_prop_freq_efficient_t;
    ...
    /// @details
    ///     - In units of MHz
    using uint32_t = xet_freq_prop_freq_request_t;
    ...
    /// @details
    ///     - In units of MHz
    using uint32_t = xet_freq_prop_freq_resolved_t;

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Data for the property ::XET_FREQ_PROP_FREQ_DIVIDER
    using freq_divider_t = xet_freq_prop_freq_divider_t;
    ...
    using uint32_t = xet_freq_prop_throttle_reasons_t;
    ...
    using uint32_t = xet_freq_prop_throttle_time_t;
    ...
    /// @details
    ///     - Bitfield of (1<<::xet_accel_asset_t)
    using uint64_t = xet_pwrwell_prop_accel_assets_t;

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Data for the property ::XET_PWRWELL_PROP_PROMO_CAP
    using xe::bool_t = xet_pwrwell_prop_promo_cap_t;

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Data for the property ::XET_PWRWELL_PROP_PROMO_MODE
    using pwrwell_promo_mode_t = xet_pwrwell_prop_promo_mode_t;
    ...
    using uint32_t = xet_pwrwell_prop_sleep_counter_t;
    ...
    /// @details
    ///     - Monotonic counter in units of seconds.
    using uint32_t = xet_pwrwell_prop_idle_counter_t;
    ...
    /// @details
    ///     - Monotonic counter in units of seconds.
    using uint32_t = xet_pwrwell_prop_active_counter_t;
    ...
    /// @details
    ///     - Monotonic counter.
    using uint32_t = xet_pwrwell_prop_wake_counter_t;
    ...
    /// @details
    ///     - Monotonic counter.
    using uint32_t = xet_pwrwell_prop_exec_counter_t;
    ...
    /// @details
    ///     - Bitfield of (1<<::xet_accel_asset_t)
    using uint64_t = xet_accel_prop_accel_assets_t;
    ...
    /// @details
    ///     - Monotonic counter in units of seconds.
    using uint32_t = xet_accel_prop_active_counter_t;
    ...
    /// @details
    ///     - Monotonic counter in units of seconds.
    using uint32_t = xet_accel_prop_idle_counter_t;

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Data for the property ::XET_MEM_PROP_TYPE
    using mem_type_t = xet_mem_prop_type_t;

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Data for the property ::XET_MEM_PROP_ECC_CAP
    using xe::bool_t = xet_mem_prop_ecc_cap_t;

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Data for the property ::XET_MEM_PROP_ECC_CLEAR
    using xe::bool_t = xet_mem_prop_ecc_clear_t;

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Data for the property ::XET_MEM_PROP_ECC_POISON
    using xe::bool_t = xet_mem_prop_ecc_poison_t;

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Data for the property ::XET_LINK_PROP_TYPE
    using link_type_t = xet_link_prop_type_t;

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Data for the property ::XET_LINK_PROP_BUS_ADDRESS
    using string_property_t = xet_link_prop_bus_address_t;

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Data for the property ::XET_LINK_PROP_PWR_CAP
    using xe::bool_t = xet_link_prop_pwr_cap_t;

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Data for the property ::XET_LINK_PROP_MAX_PACKET_SIZE
    using uint32_t = xet_link_prop_max_packet_size_t;

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Data for the property ::XET_LINK_PROP_REPLAY_COUNTER
    using uint32_t = xet_link_prop_replay_counter_t;
    ...
    public:
        ...
        struct res_container_info_t
        {
            ...
            uint32_t numPeers;                              ///< [out] The number of resource containers connected with peer-to-peer
                                                            ///< links
            uint32_t numResourcesByType[RESOURCE_TYPE_MAX_TYPES];   ///< [out] The number of resources of each type attached to this resource
        ...
        struct event_data_t
        {
            SysmanResContainer* hResContainer;              ///< [out] The resource container that generated the event
    ...
    public:
        ...
        {
            int8_t str[32];                                 ///< [out] NULL terminated string value
        ...
        struct pci_bar_info_t
        {
            ...
            uin64_t base;                                   ///< [out] Base address of the bar.
            uin64_t size;                                   ///< [out] Size of the bar.
        ...
        struct device_prop_accel_assest_t
        {
            uint64_t assetBitfield;                         ///< [out] A bitfield of assets available in the resource container
            device_prop_accel_asset_t assetInfo[ACCEL_ASSET_MAX_TYPES]; ///< [out] Information about each asset.
        ...
        struct device_prop_error_stats_t
        {
            ...
            uint32_t errors[HW_ERROR_COUNT];                ///< [out] Error counters for each type (::xet_hw_error_type_t) of hardware
                                                            ///< error.
    ...
    public:
        ...
        ///     - The implementation of this function should be lock-free.
        /// @returns
        ///     - SysmanResource*: array of handle of resources
        /// 
        /// @throws result_t
        void __xecall
        GetResources(
            ...
            SysmanResource** ppResources = nullptr          ///< [out][optional][range(0, *pCount)] array of pointer to resources
            );
        ...
        ///     - The implementation of this function should be lock-free.
        /// @returns
        ///     - void: A pointer to storage for the data of the requested properties.
        /// 
        /// @throws result_t
        void __xecall
        GetBoardProperties(
            uint32_t count,                                 ///< [in] The number of properties in the array pIndexes
            board_properties_t* pIndexes,                   ///< [in] An array of property indexes to be read
        ...
        GetDeviceProperties(
            uint32_t count,                                 ///< [in] The number of properties in the array pIndexes
            device_properties_t* pIndexes,                  ///< [in] An array of property indexes to be read
            uint32_t* pSize                                 ///< [in,out] Pointer to the total size of data pointed to by pValues.
                                                            ///< If size is zero, then the driver will update the value with the size
                                                            ///< required to store the requested properties.
                                                            ///< If size is less than that required to store the requested data for the
        ...
        SetDeviceProperties(
            uint32_t count,                                 ///< [in] The number of properties in the array pIndexes
            device_properties_t* pIndexes,                  ///< [in] An array of property indexes to be set
    ...
    public:
        ...
        GetPsuProperties(
            uint32_t count,                                 ///< [in] The number of properties in the array pIndexes
            psu_properties_t* pIndexes,                     ///< [in] An array of property indexes to be read
            uint32_t* pSize                                 ///< [in,out] Pointer to the total size of data pointed to by pValues.
                                                            ///< If size is zero, then the driver will update the value with the size
                                                            ///< required to store the requested properties.
                                                            ///< If size is less than that required to store the requested data for the
        ...
        SetPsuProperties(
            uint32_t count,                                 ///< [in] The number of properties in the array pIndexes
            psu_properties_t* pIndexes,                     ///< [in] An array of property indexes to be set
            void* pValues,                                  ///< [in] A pointer to storage for new settings for the specified
                                                            ///< properties.
            uint32_t size                                   ///< [in] Size of property data pointed to by pValues.
            );
        ...
        GetTempProperties(
            uint32_t count,                                 ///< [in] The number of properties in the array pIndexes
            temp_properties_t* pIndexes,                    ///< [in] An array of property indexes to be read
            uint32_t* pSize                                 ///< [in,out] Pointer to the total size of data pointed to by pValues.
                                                            ///< If size is zero, then the driver will update the value with the size
                                                            ///< required to store the requested properties.
                                                            ///< If size is less than that required to store the requested data for the
        ...
        SetTempProperties(
            uint32_t count,                                 ///< [in] The number of properties in the array pIndexes
            temp_properties_t* pIndexes,                    ///< [in] An array of property indexes to be set
            void* pValues,                                  ///< [in] A pointer to storage for new settings for the specified
                                                            ///< properties.
            uint32_t size                                   ///< [in] Size of property data pointed to by pValues.
            );
        ...
        GetFanProperties(
            uint32_t count,                                 ///< [in] The number of properties in the array pIndexes
            fan_properties_t* pIndexes,                     ///< [in] An array of property indexes to be read
            uint32_t* pSize                                 ///< [in,out] Pointer to the total size of data pointed to by pValues.
                                                            ///< If size is zero, then the driver will update the value with the size
                                                            ///< required to store the requested properties.
                                                            ///< If size is less than that required to store the requested data for the
        ...
        SetFanProperties(
            uint32_t count,                                 ///< [in] The number of properties in the array pIndexes
            fan_properties_t* pIndexes,                     ///< [in] An array of property indexes to be set
            void* pValues,                                  ///< [in] A pointer to storage for new settings for the specified
                                                            ///< properties.
            uint32_t size                                   ///< [in] Size of property data pointed to by pValues.
            );
        ...
        GetLedProperties(
            uint32_t count,                                 ///< [in] The number of properties in the array pIndexes
            led_properties_t* pIndexes,                     ///< [in] An array of property indexes to be read
            uint32_t* pSize                                 ///< [in,out] Pointer to the total size of data pointed to by pValues.
                                                            ///< If size is zero, then the driver will update the value with the size
                                                            ///< required to store the requested properties.
                                                            ///< If size is less than that required to store the requested data for the
        ...
        SetLedProperties(
            uint32_t count,                                 ///< [in] The number of properties in the array pIndexes
            led_properties_t* pIndexes,                     ///< [in] An array of property indexes to be set
            void* pValues,                                  ///< [in] A pointer to storage for new settings for the specified
                                                            ///< properties.
            uint32_t size                                   ///< [in] Size of property data pointed to by pValues.
            );
        ...
        GetFirmwareProperties(
            uint32_t count,                                 ///< [in] The number of properties in the array pIndexes
            firmware_properties_t* pIndexes,                ///< [in] An array of property indexes to be read
            uint32_t* pSize                                 ///< [in,out] Pointer to the total size of data pointed to by pValues.
                                                            ///< If size is zero, then the driver will update the value with the size
                                                            ///< required to store the requested properties.
                                                            ///< If size is less than that required to store the requested data for the
        ...
        SetFirmwareProperties(
            uint32_t count,                                 ///< [in] The number of properties in the array pIndexes
            firmware_properties_t* pIndexes,                ///< [in] An array of property indexes to be set
            void* pValues,                                  ///< [in] A pointer to storage for new settings for the specified
                                                            ///< properties.
            uint32_t size                                   ///< [in] Size of property data pointed to by pValues.
            );
        ...
        GetPwrProperties(
            uint32_t count,                                 ///< [in] The number of properties in the array pIndexes
            pwr_properties_t* pIndexes,                     ///< [in] An array of property indexes to be read
            uint32_t* pSize                                 ///< [in,out] Pointer to the total size of data pointed to by pValues.
                                                            ///< If size is zero, then the driver will update the value with the size
                                                            ///< required to store the requested properties.
                                                            ///< If size is less than that required to store the requested data for the
        ...
        SetPwrProperties(
            uint32_t count,                                 ///< [in] The number of properties in the array pIndexes
            pwr_properties_t* pIndexes,                     ///< [in] An array of property indexes to be set
            void* pValues,                                  ///< [in] A pointer to storage for new settings for the specified
                                                            ///< properties.
            uint32_t size                                   ///< [in] Size of property data pointed to by pValues.
            );
        ...
        GetFreqProperties(
            uint32_t count,                                 ///< [in] The number of properties in the array pIndexes
            freq_properties_t* pIndexes,                    ///< [in] An array of property indexes to be read
            uint32_t* pSize                                 ///< [in,out] Pointer to the total size of data pointed to by pValues.
                                                            ///< If size is zero, then the driver will update the value with the size
                                                            ///< required to store the requested properties.
                                                            ///< If size is less than that required to store the requested data for the
        ...
        SetFreqProperties(
            uint32_t count,                                 ///< [in] The number of properties in the array pIndexes
            freq_properties_t* pIndexes,                    ///< [in] An array of property indexes to be set
            void* pValues,                                  ///< [in] A pointer to storage for new settings for the specified
                                                            ///< properties.
            uint32_t size                                   ///< [in] Size of property data pointed to by pValues.
            );
        ...
        GetPwrWellProperties(
            uint32_t count,                                 ///< [in] The number of properties in the array pIndexes
            pwrwell_properties_t* pIndexes,                 ///< [in] An array of property indexes to be read
            uint32_t* pSize                                 ///< [in,out] Pointer to the total size of data pointed to by pValues.
                                                            ///< If size is zero, then the driver will update the value with the size
                                                            ///< required to store the requested properties.
                                                            ///< If size is less than that required to store the requested data for the
        ...
        SetPwrWellProperties(
            uint32_t count,                                 ///< [in] The number of properties in the array pIndexes
            pwrwell_properties_t* pIndexes,                 ///< [in] An array of property indexes to be set
            void* pValues,                                  ///< [in] A pointer to storage for new settings for the specified
                                                            ///< properties.
            uint32_t size                                   ///< [in] Size of property data pointed to by pValues.
            );
        ...
        GetAccelProperties(
            uint32_t count,                                 ///< [in] The number of properties in the array pIndexes
            accel_properties_t* pIndexes,                   ///< [in] An array of property indexes to be read
            uint32_t* pSize                                 ///< [in,out] Pointer to the total size of data pointed to by pValues.
                                                            ///< If size is zero, then the driver will update the value with the size
                                                            ///< required to store the requested properties.
                                                            ///< If size is less than that required to store the requested data for the
        ...
        SetAccelProperties(
            uint32_t count,                                 ///< [in] The number of properties in the array pIndexes
            accel_properties_t* pIndexes,                   ///< [in] An array of property indexes to be set
            void* pValues,                                  ///< [in] A pointer to storage for new settings for the specified
                                                            ///< properties.
            uint32_t size                                   ///< [in] Size of property data pointed to by pValues.
            );
        ...
        GetMemProperties(
            uint32_t count,                                 ///< [in] The number of properties in the array pIndexes
            mem_properties_t* pIndexes,                     ///< [in] An array of property indexes to be read
            uint32_t* pSize                                 ///< [in,out] Pointer to the total size of data pointed to by pValues.
                                                            ///< If size is zero, then the driver will update the value with the size
                                                            ///< required to store the requested properties.
                                                            ///< If size is less than that required to store the requested data for the
        ...
        SetMemProperties(
            uint32_t count,                                 ///< [in] The number of properties in the array pIndexes
            mem_properties_t* pIndexes,                     ///< [in] An array of property indexes to be set
            void* pValues,                                  ///< [in] A pointer to storage for new settings for the specified
                                                            ///< properties.
            uint32_t size                                   ///< [in] Size of property data pointed to by pValues.
            );
        ...
        GetLinkProperties(
            uint32_t count,                                 ///< [in] The number of properties in the array pIndexes
            link_properties_t* pIndexes,                    ///< [in] An array of property indexes to be read
            uint32_t* pSize                                 ///< [in,out] Pointer to the total size of data pointed to by pValues.
                                                            ///< If size is zero, then the driver will update the value with the size
                                                            ///< required to store the requested properties.
                                                            ///< If size is less than that required to store the requested data for the
        ...
        SetLinkProperties(
            uint32_t count,                                 ///< [in] The number of properties in the array pIndexes
            link_properties_t* pIndexes,                    ///< [in] An array of property indexes to be set
            void* pValues,                                  ///< [in] A pointer to storage for new settings for the specified
                                                            ///< properties.
            uint32_t size                                   ///< [in] Size of property data pointed to by pValues.
            );
...
namespace xet
{
    ...
    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Converts SysmanResContainer::string_property_t to std::string
    std::string to_string( const SysmanResContainer::string_property_t val );
    ...
    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Converts SysmanResContainer::device_prop_accel_assest_t to std::string
    std::string to_string( const SysmanResContainer::device_prop_accel_assest_t val );
    ...
    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Converts SysmanResource::fan_speed_t to std::string
    std::string to_string( const SysmanResource::fan_speed_t val );
    ...
    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Converts SysmanResource::led_state_t to std::string
    std::string to_string( const SysmanResource::led_state_t val );
    ...
    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Converts SysmanResource::freq_range_t to std::string
    std::string to_string( const SysmanResource::freq_range_t val );
