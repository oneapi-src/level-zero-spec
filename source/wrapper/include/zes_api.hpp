...
namespace zes
{
    ...
    public:
        ...
        struct config_t
        {
            ...
            details_t detailedThresholds;                   ///< [in,out] If the RAS errors for each category exceed the threshold for
    ...
    public:
        ...
        GetState(
            ...
            details_t* pDetails = nullptr                   ///< [in,out][optional] Breakdown of where errors have occurred
            );
