...
static uint32_t MemcpyBytes_SurfaceStateHeap_Gen9core[] = {
    ...
    0x00000000, 0x5cbd3000, 0x00000221, 0x00000000, 0x00000000, 0x00000000, 0x00000000,
    0x00000000, 0x00000000, 0x87fd4000, 0x04000000, 0x001f007f, 0x00000000, 0x00000000,
    0x00000000, 0x00000000, 0x00000000, 0x5cbcd000, 0x00000221, 0x00000000, 0x00000000,
...
static const PrecompiledFunctionMockData MemcpyBytes_Gen9core{
    ...
    MemcpyBytes_ISA_Gen9core,
    sizeof(MemcpyBytes_ISA_Gen9core),
    MemcpyBytes_CrossThreadDataBase_Gen9core,
    sizeof(MemcpyBytes_CrossThreadDataBase_Gen9core),
    MemcpyBytes_PerThreadDataBase_Gen9core,
    sizeof(MemcpyBytes_PerThreadDataBase_Gen9core),
    ...
    MemcpyBytes_BufferArgIndicesAndOffsets_Gen9core,
    sizeof(MemcpyBytes_BufferArgIndicesAndOffsets_Gen9core) /
        sizeof(MemcpyBytes_BufferArgIndicesAndOffsets_Gen9core[0]),
    MemcpyBytes_HasBarriers_Gen9core,
    MemcpyBytes_SlmSize_Gen9core,
    MemcpyBytes_HasPrintfOutput_Gen9core};

RegisterPrecompiledFunctionMocksData Register_MemcpyBytes_Gen9core{&MemcpyBytes_Gen9core,
                                                                   "MemcpyBytes", "Gen9core"};
