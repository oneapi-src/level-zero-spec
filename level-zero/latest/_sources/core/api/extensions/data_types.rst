...
.. _ze-command-queue-set-priority-ext-version-t:
...
.. doxygenenum:: ze_command_queue_set_priority_ext_version_t
    :project: LevelZero


.. _ze-init-driver-app-version-ext-version-t:
...
.. doxygenenum:: ze_init_driver_app_version_ext_version_t
    :project: LevelZero


.. _ze-ipc-phys-mem-handle-range-ext-version-t:
...
.. doxygenenum:: ze_ipc_phys_mem_handle_range_ext_version_t
    :project: LevelZero


.. _ze-device-npu-properties-ext-version-t:
...
.. doxygenenum:: ze_device_npu_properties_ext_version_t
    :project: LevelZero


.. _ze-power-saving-hint-ext-version-t:
...
.. doxygenenum:: ze_power_saving_hint_ext_version_t
    :project: LevelZero

 
Data Types - Extension Structures
=================================
