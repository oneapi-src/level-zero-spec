...
*Introduced in Level Zero version 1.16*
...
User may query support for compute capability support on the device using the compute dot product capability extension supported under device compute properties(:ref:`ze-device-compute-properties-t`\).
