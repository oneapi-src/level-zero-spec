...
*Introduced in Level Zero version 1.10*
...
.. parsed-literal::
    ...
    :ref:`zetMetricTracerReadDataExp`\(hMetricTracer, &rawDataSize, rawData);
    ...
    while (rawDataSize == readingBufferSize) {
        ...
        :ref:`zetMetricTracerReadDataExp`\(hMetricTracer, &rawDataSize, rawDataExtended);
    ...
    uint32_t setCount = 0;
    :ref:`zetMetricTracerDecodeExp`\(hMetricDecoder,  &totalDataRead, rawData, numDecodableMetrics, decodableMetrics.data(),
