...
- ze_context_handle_t :ref:`ZERGetDefaultContext`\();
- ze_context_handle_t :ref:`zeDriverGetDefaultContext`\(ze_driver_handle_t hDriver);

Semantics:

- :ref:`ZERGetDefaultContext` returns the default context for the default driver (index 0).
- :ref:`zeDriverGetDefaultContext` returns the default context for a specified driver.
...
- uint32_t :ref:`ZERTranslateDeviceHandleToIdentifier`\(ze_device_handle_t hDevice);
- ze_device_handle_t :ref:`ZERTranslateIdentifierToDeviceHandle`\(uint32_t identifier);
...
- :ref:`ZERTranslateDeviceHandleToIdentifier` returns the integer identifier for a device handle.
- :ref:`ZERTranslateIdentifierToDeviceHandle` returns the device handle for a given identifier (driver must be initialized).
...
- ze_result_t :ref:`zeDeviceSynchronize`\(ze_device_handle_t hDevice);
