...
namespace xet
{
        ...
        )
    {
        ...
        auto result = static_cast<result_t>( ::xetSysmanGetResourceContainerByUuid(
            reinterpret_cast<xet_sysman_handle_t>( getHandle() ),
            static_cast<xet_res_container_uuid_t>( uuid ),
            &hResContainer ) );
    ...
    SysmanResContainer::GetResources(
        ...
        uint32_t* pCount,                               ///< [in,out] Pointer to the number of resource.
                                                        ...
                                                        ///< driver will update the value with the correct number of resources of a
                                                        ///< given type that are available.
        SysmanResource** ppResources                    ///< [out][optional][range(0, *pCount)] array of pointer to resources
        )
    {
        ...
        {
            for( uint32_t i = 0; ( ppResources ) && ( i < *pCount ); ++i )
                ppResources[ i ] = new SysmanResource( reinterpret_cast<resource_handle_t>( hResources[ i ] ), m_pResContainer );
        }
        catch( std::bad_alloc& )
        {
            for( uint32_t i = 0; ( ppResources ) && ( i < *pCount ); ++i )
            ...
            throw exception_t( result_t::ERROR_OUT_OF_HOST_MEMORY, __FILE__, STRING(__LINE__), "xet::SysmanResContainer::GetResources" );
        }
    }
        ...
        )
    {
        ...
        auto result = static_cast<result_t>( ::xetSysmanResContainerGetBoardProperties(
            reinterpret_cast<xet_res_container_handle_t>( getHandle() ),
            count,
            reinterpret_cast<xet_board_properties_t*>( pIndexes ),
            &values,
            pSize ) );
        ...
        )
    {
        ...
        auto result = static_cast<result_t>( ::xetSysmanResContainerGetDeviceProperties(
            reinterpret_cast<xet_res_container_handle_t>( getHandle() ),
            count,
            reinterpret_cast<xet_device_properties_t*>( pIndexes ),
            &values,
            pSize ) );
        ...
        )
    {
        ...
        auto result = static_cast<result_t>( ::xetSysmanResourceGetPsuProperties(
            reinterpret_cast<xet_resource_handle_t>( getHandle() ),
            count,
            reinterpret_cast<xet_psu_properties_t*>( pIndexes ),
            &values,
            pSize ) );
        ...
        )
    {
        ...
        auto result = static_cast<result_t>( ::xetSysmanResourceGetTempProperties(
            reinterpret_cast<xet_resource_handle_t>( getHandle() ),
            count,
            reinterpret_cast<xet_temp_properties_t*>( pIndexes ),
            &values,
            pSize ) );
        ...
        )
    {
        ...
        auto result = static_cast<result_t>( ::xetSysmanResourceGetFanProperties(
            reinterpret_cast<xet_resource_handle_t>( getHandle() ),
            count,
            reinterpret_cast<xet_fan_properties_t*>( pIndexes ),
            &values,
            pSize ) );
        ...
        )
    {
        ...
        auto result = static_cast<result_t>( ::xetSysmanResourceGetLedProperties(
            reinterpret_cast<xet_resource_handle_t>( getHandle() ),
            count,
            reinterpret_cast<xet_led_properties_t*>( pIndexes ),
            &values,
            pSize ) );
        ...
        )
    {
        ...
        auto result = static_cast<result_t>( ::xetSysmanResourceGetFirmwareProperties(
            reinterpret_cast<xet_resource_handle_t>( getHandle() ),
            count,
            reinterpret_cast<xet_firmware_properties_t*>( pIndexes ),
            &values,
            pSize ) );
        ...
        )
    {
        ...
        auto result = static_cast<result_t>( ::xetSysmanResourceGetPwrProperties(
            reinterpret_cast<xet_resource_handle_t>( getHandle() ),
            count,
            reinterpret_cast<xet_pwr_properties_t*>( pIndexes ),
            &values,
            pSize ) );
        ...
        )
    {
        ...
        auto result = static_cast<result_t>( ::xetSysmanResourceGetFreqProperties(
            reinterpret_cast<xet_resource_handle_t>( getHandle() ),
            count,
            reinterpret_cast<xet_freq_properties_t*>( pIndexes ),
            &values,
            pSize ) );
        ...
        )
    {
        ...
        auto result = static_cast<result_t>( ::xetSysmanResourceGetPwrWellProperties(
            reinterpret_cast<xet_resource_handle_t>( getHandle() ),
            count,
            reinterpret_cast<xet_pwrwell_properties_t*>( pIndexes ),
            &values,
            pSize ) );
        ...
        )
    {
        ...
        auto result = static_cast<result_t>( ::xetSysmanResourceGetAccelProperties(
            reinterpret_cast<xet_resource_handle_t>( getHandle() ),
            count,
            reinterpret_cast<xet_accel_properties_t*>( pIndexes ),
            &values,
            pSize ) );
        ...
        )
    {
        ...
        auto result = static_cast<result_t>( ::xetSysmanResourceGetMemProperties(
            reinterpret_cast<xet_resource_handle_t>( getHandle() ),
            count,
            reinterpret_cast<xet_mem_properties_t*>( pIndexes ),
            &values,
            pSize ) );
        ...
        )
    {
        ...
        auto result = static_cast<result_t>( ::xetSysmanResourceGetLinkProperties(
            reinterpret_cast<xet_resource_handle_t>( getHandle() ),
            count,
            reinterpret_cast<xet_link_properties_t*>( pIndexes ),
            &values,
            pSize ) );
...
namespace xet
{
    ...
    std::string to_string( const Sysman::res_container_info_t val )
    {
        ...
        str += to_string(val.numChildren);
        str += "\n";
        
        str += "Sysman::res_container_info_t::numPeers : ";
        str += to_string(val.numPeers);
        str += "\n";
        
        str += "Sysman::res_container_info_t::numResourcesByType : ";
        str += to_string(val.numResourcesByType);
        str += "\n";
    ...
    std::string to_string( const Sysman::event_data_t val )
    {
        ...
        str += "Sysman::event_data_t::hResContainer : ";
        str += to_string(val.hResContainer);
        str += "\n";
        
        str += "Sysman::event_data_t::events : ";
        str += to_string(val.events);
        str += "\n";
    ...
    std::string to_string( const SysmanResContainer::string_property_t val )
    {
        ...
        str += "SysmanResContainer::string_property_t::str : ";
        {
            std::string tmp;
    ...
    std::string to_string( const SysmanResContainer::device_prop_accel_assest_t val )
    {
        ...
        str += "SysmanResContainer::device_prop_accel_assest_t::assetBitfield : ";
        str += to_string(val.assetBitfield);
        str += "\n";
        
        str += "SysmanResContainer::device_prop_accel_assest_t::assetInfo : ";
        str += to_string(val.assetInfo);
        str += "\n";
    ...
    std::string to_string( const SysmanResource::fan_speed_t val )
    {
        ...
        str += "SysmanResource::fan_speed_t::speed : ";
        str += to_string(val.speed);
        str += "\n";
        
        str += "SysmanResource::fan_speed_t::units : ";
    ...
    std::string to_string( const SysmanResource::led_state_t val )
    {
        ...
        str += "SysmanResource::led_state_t::isOn : ";
        str += std::to_string(val.isOn);
        str += "\n";
        
        str += "SysmanResource::led_state_t::red : ";
        str += std::to_string(val.red);
        str += "\n";
        
        str += "SysmanResource::led_state_t::green : ";
        str += std::to_string(val.green);
        str += "\n";
        
        str += "SysmanResource::led_state_t::blue : ";
    ...
    std::string to_string( const SysmanResource::freq_range_t val )
    {
        ...
        str += "SysmanResource::freq_range_t::min : ";
        str += to_string(val.min);
        str += "\n";
        
        str += "SysmanResource::freq_range_t::max : ";
    ...
    std::string to_string( const SysmanResource::mem_prop_utilization_t val )
    {
        ...
        str += to_string(val.allocated);
        str += "\n";
        
        str += "SysmanResource::mem_prop_utilization_t::unallocated : ";
        str += to_string(val.unallocated);
        str += "\n";
    ...
    std::string to_string( const SysmanResource::link_prop_bandwidth_t val )
    {
        ...
        str += to_string(val.recvCounter);
        str += "\n";
        
        str += "SysmanResource::link_prop_bandwidth_t::sendCounter : ";
        str += to_string(val.sendCounter);
        str += "\n";
