...
IPCMemoryManager *IPCMemoryManager::create() {
    return new WddmIPCMemoryManager();
}
...
xe_result_t WddmIPCMemoryManager::ipcOpenMemHandle(xe_device_handle_t hDevice, xe_ipc_mem_handle_t handle,
                             xe_ipc_memory_flag_t flags, void **ptr) {

    return XE_RESULT_ERROR_UNSUPPORTED;
}

xe_result_t WddmIPCMemoryManager::ipcCloseMemHandle(const void *ptr) { return XE_RESULT_ERROR_UNSUPPORTED; }
