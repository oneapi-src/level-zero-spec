...
template <> struct WhiteBox<::L0::CommandQueue> : public ::L0::CommandQueueImp {
...
template <> struct Mock<CommandQueue> : public CommandQueue {
    Mock(Device *device = nullptr, void *csrRT = nullptr);
    virtual ~Mock();

    MOCK_METHOD2(createFence, xe_result_t(const xe_fence_desc_t *desc, xe_fence_handle_t *phFence));
    MOCK_METHOD0(destroy, xe_result_t());
    MOCK_METHOD3(executeCommandLists,
