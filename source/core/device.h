...
struct Device : _xe_device_handle_t {
    virtual xe_result_t canAccessPeer(xe_device_handle_t hPeerDevice, xe_bool_t *value) = 0;
    ...
    virtual xe_result_t createImage(const xe_image_desc_t *desc, xe_image_handle_t *phImage) = 0;

    virtual xe_result_t createModule(const xe_module_desc_t *desc, xe_module_handle_t *module,
    ...
    virtual xe_result_t evictMemory(void *ptr, size_t size) = 0;
    virtual xe_result_t getApiVersion(xe_api_version_t *version) = 0;
    virtual xe_result_t
    getComputeProperties(xe_device_compute_properties_t *pComputeProperties) = 0;
    ...
    virtual xe_result_t getSubDevice(uint32_t ordinal, xe_device_handle_t *phSubDevice) = 0;
    virtual xe_result_t makeImageResident(xe_image_handle_t hImage) = 0;
    virtual xe_result_t makeMemoryResident(void *ptr, size_t size) = 0;
    ...
    inline xe_device_handle_t toHandle() { return this; }
