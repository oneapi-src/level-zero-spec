...
static const PrecompiledFunctionMockData SlmBarrier_Gen12HPcore{
    ...
    SlmBarrier_ISA_Gen12HPcore,
    sizeof(SlmBarrier_ISA_Gen12HPcore),
    SlmBarrier_CrossThreadDataBase_Gen12HPcore,
    sizeof(SlmBarrier_CrossThreadDataBase_Gen12HPcore),
    SlmBarrier_PerThreadDataBase_Gen12HPcore,
    sizeof(SlmBarrier_PerThreadDataBase_Gen12HPcore),
    ...
    SlmBarrier_BufferArgIndicesAndOffsets_Gen12HPcore,
    sizeof(SlmBarrier_BufferArgIndicesAndOffsets_Gen12HPcore) /
        sizeof(SlmBarrier_BufferArgIndicesAndOffsets_Gen12HPcore[0]),
    SlmBarrier_HasBarriers_Gen12HPcore,
    SlmBarrier_SlmSize_Gen12HPcore,
    SlmBarrier_HasPrintfOutput_Gen12HPcore};

RegisterPrecompiledFunctionMocksData Register_SlmBarrier_Gen12HPcore{&SlmBarrier_Gen12HPcore,
                                                                     "SlmBarrier", "Gen12HPcore"};
