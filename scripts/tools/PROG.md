...
**Note:** To avoid incorrect data, do not reconfigure the device using ::${t}DeviceActivateMetricGroups while the tracer is opened.
...
- To work with individual query object, use ::${t}MetricQueryCreate to get a handle.
