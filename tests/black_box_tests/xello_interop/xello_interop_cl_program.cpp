...
int xeInitBuffers() {
    ...
    if(ret) {
        std::cout << "xeSharedMemAlloc failed ret "
                << static_cast<int>(ret) << "\n";
        return static_cast<int>(ret);
    }
...
int xeCLRegister() {
    ...
    if(ret) {
        std::cout << "xeDeviceRegisterCLCommandQueue failed ret "
                << static_cast<int>(ret) << "\n";
        return static_cast<int>(ret);
    }
...
int main(int argc, char **argv) {
    ...
    bool test_register_cl_cmd_queue = false;
