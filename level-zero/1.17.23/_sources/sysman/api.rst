...
.. doxygenfunction:: zesPowerGetUsage
    :project: LevelZero
...
.. _zes-device-ext-state-version-t:

zes_device_ext_state_version_t
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

.. doxygenenum:: zes_device_ext_state_version_t
    :project: LevelZero


.. _zes-device-state-ext-flags-t:

zes_device_state_ext_flags_t
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

.. doxygenenum:: zes_device_state_ext_flag_t
    :project: LevelZero

 
Devicestate Structures
------------------------------------------------------------------------------

.. _zes-device-ext-state-t:

zes_device_ext_state_t
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

.. doxygenstruct:: zes_device_ext_state_t
    :project: LevelZero
    :members:
    :undoc-members:
...
.. _zes-oem-serial-id-ext-version-t:

zes_oem_serial_id_ext_version_t
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

.. doxygenenum:: zes_oem_serial_id_ext_version_t
    :project: LevelZero

 
Oemserialid Structures
------------------------------------------------------------------------------

.. _zes-oem-serial-id-ext-properties-t:

zes_oem_serial_id_ext_properties_t
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

.. doxygenstruct:: zes_oem_serial_id_ext_properties_t
    :project: LevelZero
    :members:
    :undoc-members:
...
* Functions
    ...
    * :ref:`zesPowerGetLimitsExt2`
    * :ref:`zesPowerSetLimitsExt2`
...
.. _zesPowerGetLimitsExt2:

zesPowerGetLimitsExt2
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

.. doxygenfunction:: zesPowerGetLimitsExt2
    :project: LevelZero


.. _zesPowerSetLimitsExt2:

zesPowerSetLimitsExt2
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

.. doxygenfunction:: zesPowerSetLimitsExt2
    :project: LevelZero
...
* Functions
    ...
    * :ref:`zesRasGetConfigExp`
    * :ref:`zesRasSetConfigExp`
...
.. _zesRasGetSupportedCategoriesExp:

zesRasGetSupportedCategoriesExp
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

.. doxygenfunction:: zesRasGetSupportedCategoriesExp
    :project: LevelZero
...
.. doxygenfunction:: zesRasGetStateExp2
    :project: LevelZero
...
.. doxygenfunction:: zesRasGetConfigExp
    :project: LevelZero
...
.. doxygenfunction:: zesRasSetConfigExp
    :project: LevelZero
...
.. _zes-ras-state-exp2-t:

zes_ras_state_exp2_t
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

.. doxygenstruct:: zes_ras_state_exp2_t
    :project: LevelZero
    :members:
    :undoc-members:

.. _zes-ras-config-exp-t:

zes_ras_config_exp_t
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

.. doxygenstruct:: zes_ras_config_exp_t
    :project: LevelZero
    :members:
    :undoc-members:
