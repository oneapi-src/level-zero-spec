...
{
    ZES_VERSION_1_0 = ZE_MAKE_VERSION( 1, 0 ),      ///< version 1.0
    ZES_VERSION_CURRENT = ZE_MAKE_VERSION( 1, 0 ),  ///< latest known version
...
{
    ZES_RAS_ERROR_CAT_RESET = 0,                    ///< The number of device resets that have taken place
    ZES_RAS_ERROR_CAT_PROGRAMMING_ERRORS,           ///< The number of hardware exceptions generated by the way workloads have
                                                    ///< programmed the hardware
    ZES_RAS_ERROR_CAT_DRIVER_ERRORS,                ///< The number of low level driver communication errors have occurred
    ZES_RAS_ERROR_CAT_COMPUTE_ERRORS,               ///< The number of errors that have occurred in the compute accelerator
                                                    ///< hardware
    ZES_RAS_ERROR_CAT_NON_COMPUTE_ERRORS,           ///< The number of errors that have occurred in the fixed-function
                                                    ///< accelerator hardware
    ZES_RAS_ERROR_CAT_CACHE_ERRORS,                 ///< The number of errors that have occurred in caches (L1/L3/register
                                                    ///< file/shared local memory/sampler)
    ZES_RAS_ERROR_CAT_DISPLAY_ERRORS,               ///< The number of errors that have occurred in the display
    ZES_RAS_ERROR_CAT_MAX,                          ///< The number of categories
...
{
    uint64_t category[ZES_RAS_ERROR_CAT_MAX];       ///< [in][out] Breakdown of error by category
