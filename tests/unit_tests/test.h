...
#define SKL_TYPED_CMDTEST_BODY                                                                     \
    runCmdTestHwIfSupported<typename NEO::GfxFamilyMapper<IGFX_GEN9_CORE>::GfxFamily>();
#else
...
#define ICL_TYPED_CMDTEST_BODY                                                                     \
    runCmdTestHwIfSupported<typename NEO::GfxFamilyMapper<IGFX_GEN11_CORE>::GfxFamily>();
#else
...
#define ATS_TYPED_CMDTEST_BODY                                                                     \
    runCmdTestHwIfSupported<typename NEO::GfxFamilyMapper<IGFX_GEN12_CORE>::GfxFamily>();
#else
...
#define TGLLP_TYPED_TEST_BODY                                                                      \
    testBodyHw<typename NEO::GfxFamilyMapper<IGFX_GEN12LP_CORE>::GfxFamily>();
#define TGLLP_TYPED_CMDTEST_BODY                                                                   \
    runCmdTestHwIfSupported<typename NEO::GfxFamilyMapper<IGFX_GEN12LP_CORE>::GfxFamily>();
#else
#define TGLLP_TYPED_TEST_BODY
#define TGLLP_TYPED_CMDTEST_BODY
#endif
    ...
    class GTEST_TEST_CLASS_NAME_(test_suite_name, test_name) : public parent_class {               \
      ...
      public:                                                                                      \
        ...
        () {}                                                                                      \
                                                                                                   \
      private:                                                                                     \
        template <typename FamilyType> void testBodyHw();                                          \
                                                                                                   \
...
#define HWTEST2_TEST_(test_suite_name, test_name, parent_class, parent_id, test_matcher)           \
    class GTEST_TEST_CLASS_NAME_(test_suite_name, test_name) : public parent_class {               \
      ...
      private:                                                                                     \
        ...
        void matchBody();                                                                          \
                                                                                                   \
        template <PRODUCT_FAMILY productFamily> void matched() {                                   \
            ...
            matchBody<productFamily, gfxCoreFamily, FamilyType>();                                 \
                                                                                                   ...
                                                                                                   \
        struct MatcherFalse {                                                                      \
            template <PRODUCT_FAMILY productFamily> static void matched() {}                       \
        };                                                                                         \
                                                                                                   \
        template <unsigned int matcherOrdinal> void checkForMatch(PRODUCT_FAMILY matchProduct);    \
                                                                                                   \
        void TestBody() override {                                                                 \
    ...
    class GTEST_TEST_CLASS_NAME_(test_suite_name, test_name) : public parent_class {               \
      ...
      private:                                                                                     \
        template <typename FamilyType> void testBodyHw();                                          \
                                                                                                   \
        template <typename FamilyType,                                                             \
                  bool ShouldBeTested = FamilyType::supportsCmdSet(cmdset_gen_base)>               \
...
#define FAMILYTEST_TEST_(test_suite_name, test_name, parent_class, parent_id, match_core,          \
                         match_product)                                                            \
    class GTEST_TEST_CLASS_NAME_(test_suite_name, test_name) : public parent_class {               \
      public:                                                                                      \
        GTEST_TEST_CLASS_NAME_(test_suite_name, test_name)                                         \
      ...
      private:                                                                                     \
        ...
        void SetUp() override { CALL_IF_MATCH(match_core, match_product, parent_class::SetUp()) }  \
      ...
      private:                                                                                     \
        static int AddToRegistry() {                                                               \
            ::testing::UnitTest::GetInstance()                                                     \
                ...
                .GetTestCasePatternHolder<test_suite_name>(#test_suite_name, __FILE__, __LINE__)   \
...
#define GEN9TEST_F(test_fixture, test_name)                                                        \
    FAMILYTEST_TEST_(test_fixture, test_name, test_fixture,                                        \
                     ::testing::internal::GetTypeId<test_fixture>(), IGFX_GEN9_CORE,               \
                     IGFX_MAX_PRODUCT)
#define GEN9TEST_P(test_suite_name, test_name)                                                     \
    FAMILYTEST_TEST_P(test_suite_name, test_name, IGFX_GEN9_CORE, IGFX_MAX_PRODUCT)
#endif
#ifdef TESTS_SKL
#define SKLTEST_F(test_fixture, test_name)                                                         \
    FAMILYTEST_TEST_(test_fixture, test_name, test_fixture,                                        \
                     ::testing::internal::GetTypeId<test_fixture>(), IGFX_GEN9_CORE, IGFX_SKYLAKE)
#define SKLTEST_P(test_suite_name, test_name)                                                      \
    FAMILYTEST_TEST_P(test_suite_name, test_name, IGFX_GEN9_CORE, IGFX_SKYLAKE)
#endif
#ifdef TESTS_KBL
...
#define KBLTEST_P(test_suite_name, test_name)                                                      \
    FAMILYTEST_TEST_P(test_suite_name, test_name, IGFX_GEN9_CORE, IGFX_KABYLAKE)
#endif
#ifdef TESTS_GLK
...
#define GLKTEST_P(test_suite_name, test_name)                                                      \
    FAMILYTEST_TEST_P(test_suite_name, test_name, IGFX_GEN9_CORE, IGFX_GEMINILAKE)
#endif
#ifdef TESTS_BXT
#define BXTTEST_F(test_fixture, test_name)                                                         \
    FAMILYTEST_TEST_(test_fixture, test_name, test_fixture,                                        \
                     ::testing::internal::GetTypeId<test_fixture>(), IGFX_GEN9_CORE, IGFX_BROXTON)
#define BXTTEST_P(test_suite_name, test_name)                                                      \
    FAMILYTEST_TEST_P(test_suite_name, test_name, IGFX_GEN9_CORE, IGFX_BROXTON)
#endif
#ifdef TESTS_CFL
...
#define CFLTEST_P(test_suite_name, test_name)                                                      \
    FAMILYTEST_TEST_P(test_suite_name, test_name, IGFX_GEN9_CORE, IGFX_COFFEELAKE)
#endif
#ifdef TESTS_GEN11
#define ICLLPTEST_F(test_fixture, test_name)                                                       \
    FAMILYTEST_TEST_(test_fixture, test_name, test_fixture,                                        \
                     ::testing::internal::GetTypeId<test_fixture>(), IGFX_GEN11_CORE,              \
                     IGFX_ICELAKE_LP)
#define ICLLPTEST_P(test_case_name, test_name)                                                     \
    FAMILYTEST_TEST_P(test_case_name, test_name, IGFX_GEN11_CORE, IGFX_ICELAKE_LP)
#define LKFTEST_F(test_fixture, test_name)                                                         \
    FAMILYTEST_TEST_(test_fixture, test_name, test_fixture,                                        \
                     ::testing::internal::GetTypeId<test_fixture>(), IGFX_GEN11_CORE,              \
                     IGFX_LAKEFIELD)
#define LKFTEST_P(test_case_name, test_name)                                                       \
    FAMILYTEST_TEST_P(test_case_name, test_name, IGFX_GEN11_CORE, IGFX_LAKEFIELD)
#define EHLTEST_F(test_fixture, test_name)                                                         \
    FAMILYTEST_TEST_(test_fixture, test_name, test_fixture,                                        \
                     ::testing::internal::GetTypeId<test_fixture>(), IGFX_GEN11_CORE,              \
                     IGFX_JASPERLAKE)
#define EHLTEST_P(test_case_name, test_name)                                                       \
    FAMILYTEST_TEST_P(test_case_name, test_name, IGFX_GEN11_CORE, IGFX_JASPERLAKE)
#endif
#ifdef TESTS_GEN12HP
#define ATSTEST_F(test_fixture, test_name)                                                         \
    FAMILYTEST_TEST_(test_fixture, test_name, test_fixture,                                        \
                     ::testing::internal::GetTypeId<test_fixture>(), IGFX_GEN12_CORE,              \
                     IGFX_TIGERLAKE_HP)
#define ATSTEST_P(test_case_name, test_name)                                                       \
    FAMILYTEST_TEST_P(test_case_name, test_name, IGFX_GEN12_CORE, IGFX_TIGERLAKE_HP)
#endif
#ifdef TESTS_GEN12LP
#define TGLLPTEST_F(test_fixture, test_name)                                                       \
    FAMILYTEST_TEST_(test_fixture, test_name, test_fixture,                                        \
                     ::testing::internal::GetTypeId<test_fixture>(), IGFX_GEN12LP_CORE,            \
                     IGFX_TIGERLAKE_LP)
#define TGLLPTEST_P(test_case_name, test_name)                                                     \
    FAMILYTEST_TEST_P(test_case_name, test_name, IGFX_GEN12LP_CORE, IGFX_TIGERLAKE_LP)
#define RYFTEST_F(test_fixture, test_name)                                                         \
    FAMILYTEST_TEST_(test_fixture, test_name, test_fixture,                                        \
                     ::testing::internal::GetTypeId<test_fixture>(), IGFX_GEN12LP_CORE,            \
                     IGFX_RYEFIELD)
#define RYFTEST_P(test_case_name, test_name)                                                       \
    FAMILYTEST_TEST_P(test_case_name, test_name, IGFX_GEN12LP_CORE, IGFX_RYEFIELD)
#define DG1TEST_F(test_fixture, test_name)                                                         \
    FAMILYTEST_TEST_(test_fixture, test_name, test_fixture,                                        \
                     ::testing::internal::GetTypeId<test_fixture>(), IGFX_GEN12LP_CORE, IGFX_DG1)
#define DG1TEST_P(test_case_name, test_name)                                                       \
    FAMILYTEST_TEST_P(test_case_name, test_name, IGFX_GEN12LP_CORE, IGFX_DG1)
#define RKLTEST_F(test_fixture, test_name)                                                         \
    FAMILYTEST_TEST_(test_fixture, test_name, test_fixture,                                        \
                     ::testing::internal::GetTypeId<test_fixture>(), IGFX_GEN12LP_CORE,            \
                     IGFX_ROCKETLAKE)
#define RKLTEST_P(test_case_name, test_name)                                                       \
    FAMILYTEST_TEST_P(test_case_name, test_name, IGFX_GEN12LP_CORE, IGFX_ROCKETLAKE)
#endif
...
template <typename Fixture> struct Test : public Fixture, public ::testing::Test {
...
template <PRODUCT_FAMILY... args> struct SupportedProductFamilyContainer {
...
using SupportedProductFamilies =
    SupportedProductFamilyContainer<IGFX_SKYLAKE, IGFX_TIGERLAKE_LP, IGFX_TIGERLAKE_HP>;

// Static container accessor
template <typename Container, int index> struct At {
    static const PRODUCT_FAMILY productFamily =
        At<typename Container::BaseClass, index - 1>::productFamily;
};

template <typename Container> struct At<Container, 0> {
    static const PRODUCT_FAMILY productFamily = Container::productFamily;
};

// HWTEST2_F matchers
template <GFXCORE_FAMILY gfxCoreFamily> struct IsGfxCore {
    template <PRODUCT_FAMILY productFamily> static constexpr bool isMatched() {
        return ToGfxCoreFamily<productFamily>::get() == gfxCoreFamily;
    }
};

template <PRODUCT_FAMILY product> struct IsProduct {
    template <PRODUCT_FAMILY productFamily> static constexpr bool isMatched() {
        return productFamily == product;
    }
};

template <PRODUCT_FAMILY productFamilyMax> struct IsAtMostProduct {
    template <PRODUCT_FAMILY productFamily> static constexpr bool isMatched() {
        return productFamily <= productFamilyMax;
    }
};

template <PRODUCT_FAMILY productFamilyMin> struct IsAtLeastProduct {
    template <PRODUCT_FAMILY productFamily> static constexpr bool isMatched() {
...
struct MatchAny {
    template <PRODUCT_FAMILY productFamily> static constexpr bool isMatched() { return true; }
};
