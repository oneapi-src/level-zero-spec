...
class xet_string_property_t(Structure):
    _fields_ = [
        ("str", c_int8_t * 32)                                          ## [out] NULL terminated string value
    ]
...
class xet_string_property_t(xet_board_prop_serial_number_t):
    pass
...
class xet_pci_bar_info_t(Structure):
    _fields_ = [
        ...
        ("base", uin64_t),                                              ## [out] Base address of the bar.
        ("size", uin64_t)                                               ## [out] Size of the bar.
    ]
...
class xet_string_property_t(xet_device_prop_brand_t):
    pass

###############################################################################
## @brief Data for the property ::XET_DEVICE_PROP_MODEL
class xet_string_property_t(xet_device_prop_model_t):
    pass

###############################################################################
## @brief Data for the property ::XET_DEVICE_PROP_DEVICEID
class xet_string_property_t(xet_device_prop_deviceid_t):
    pass

###############################################################################
## @brief Data for the property ::XET_DEVICE_PROP_VENDOR_NAME
class xet_string_property_t(xet_device_prop_vendor_name_t):
    pass
...
class xet_device_prop_accel_assest_t(Structure):
    _fields_ = [
...
class xet_string_property_t(xet_device_prop_driver_version_t):
    pass
...
class xe_bool_t(xet_device_prop_driver_cold_shutdown_t):
    pass

###############################################################################
## @brief Data for the property ::XET_DEVICE_PROP_COLD_RESET
class xe_bool_t(xet_device_prop_driver_cold_reset_t):
    pass
...
class uint32_t(xet_psu_prop_amp_limit_t):
    pass

###############################################################################
## @brief Data for the property ::XET_PSU_PROP_VOLTAGE_STATUS
class xet_psu_voltage_status_t(xet_psu_prop_voltage_status_t):
    pass

###############################################################################
## @brief Data for the property ::XET_PSU_PROP_FAN_FAILURE
class xe_bool_t(xet_psu_prop_fan_failure_t):
    pass

###############################################################################
## @brief Data for the property ::XET_PSU_PROP_TEMPERATURE
class uint32_t(xet_psu_prop_temperature_t):
    pass

###############################################################################
## @brief Data for the property ::XET_PSU_PROP_AMPS
class uint32_t(xet_psu_prop_amps_t):
    pass
...
###############################################################################
## @brief Fan speed
class xet_fan_speed_t(Structure):
    _fields_ = [
...
class uint32_t(xet_fan_prop_max_rpm_t):
    pass

###############################################################################
## @brief Data for the property ::XET_FAN_PROP_MAX_TABLE_SIZE
class uint32_t(xet_fan_prop_max_table_c_size_t):
    pass

###############################################################################
## @brief Data for the property ::XET_FAN_PROP_SPEED_RPM
class uint32_t(xet_fan_prop_speed_rpm_t):
    pass

###############################################################################
## @brief Data for the property ::XET_FAN_PROP_SPEED_PERCENT
class uint32_t(xet_fan_prop_speed_percent_t):
    pass

###############################################################################
## @brief Data for the property ::XET_FAN_PROP_MODE
class xet_fan_speed_mode_t(xet_fan_prop_mode_t):
    pass

###############################################################################
## @brief Data for the property ::XET_FAN_PROP_FIXED_SPEED
class xet_fan_speed_t(xet_fan_prop_fixed_speed_t):
    pass
...
class xe_bool_t(xet_led_prop_rgb_cap_t):
    pass

###############################################################################
## @brief Data for the property ::XET_LED_PROP_STATE
class xet_led_state_t(xet_led_prop_state_t):
    pass
...
class xet_string_property_t(xet_firmware_prop_name_t):
    pass

###############################################################################
## @brief Data for the property ::XET_FIRMWARE_PROP_VERSION
class xet_string_property_t(xet_firmware_prop_version_t):
    pass
...
class uint64_t(xet_pwr_prop_accel_assets_t):
    pass
...
class uint32_t(xet_pwr_prop_max_limit_t):
    pass
...
class uint64_t(xet_pwr_prop_energy_counter_t):
    pass
...
## @details
##     - Bitfield of (1<<::xet_accel_asset_t)
class uint64_t(xet_freq_prop_accel_assets_t):
    pass

###############################################################################
## @brief Data for the property ::XET_FREQ_PROP_DOMAIN_TYPE
class xet_freq_domain_type_t(xet_freq_prop_domain_type_t):
    pass
...
class xet_resource_uuid_t(xet_freq_prop_src_freq_t):
    pass

###############################################################################
## @brief Data for the property ::XET_FREQ_PROP_DVFS_MODE
class xet_dvfs_mode_t(xet_freq_prop_dvfs_mode_t):
    pass

###############################################################################
## @brief Data for the property ::XET_FREQ_PROP_FREQ_RANGE
class xet_freq_range_t(xet_freq_prop_freq_range_t):
    pass
...
## @details
##     - In units of MHz
class uint32_t(xet_freq_prop_freq_tdp_t):
    pass
...
## @details
##     - In units of MHz
class uint32_t(xet_freq_prop_freq_efficient_t):
    pass
...
## @details
##     - In units of MHz
class uint32_t(xet_freq_prop_freq_request_t):
    pass
...
## @details
##     - In units of MHz
class uint32_t(xet_freq_prop_freq_resolved_t):
    pass

###############################################################################
## @brief Data for the property ::XET_FREQ_PROP_FREQ_DIVIDER
class xet_freq_divider_t(xet_freq_prop_freq_divider_t):
    pass
...
class uint32_t(xet_freq_prop_throttle_reasons_t):
    pass
...
class uint32_t(xet_freq_prop_throttle_time_t):
    pass
...
## @details
##     - Bitfield of (1<<::xet_accel_asset_t)
class uint64_t(xet_pwrwell_prop_accel_assets_t):
    pass

###############################################################################
## @brief Data for the property ::XET_PWRWELL_PROP_PROMO_CAP
class xe_bool_t(xet_pwrwell_prop_promo_cap_t):
    pass

###############################################################################
## @brief Data for the property ::XET_PWRWELL_PROP_PROMO_MODE
class xet_pwrwell_promo_mode_t(xet_pwrwell_prop_promo_mode_t):
    pass
...
class uint32_t(xet_pwrwell_prop_sleep_counter_t):
    pass
...
## @details
##     - Monotonic counter in units of seconds.
class uint32_t(xet_pwrwell_prop_idle_counter_t):
    pass
...
## @details
##     - Monotonic counter in units of seconds.
class uint32_t(xet_pwrwell_prop_active_counter_t):
    pass
...
## @details
##     - Monotonic counter.
class uint32_t(xet_pwrwell_prop_wake_counter_t):
    pass
...
## @details
##     - Monotonic counter.
class uint32_t(xet_pwrwell_prop_exec_counter_t):
    pass
...
## @details
##     - Bitfield of (1<<::xet_accel_asset_t)
class uint64_t(xet_accel_prop_accel_assets_t):
    pass
...
## @details
##     - Monotonic counter in units of seconds.
class uint32_t(xet_accel_prop_active_counter_t):
    pass
...
## @details
##     - Monotonic counter in units of seconds.
class uint32_t(xet_accel_prop_idle_counter_t):
    pass
...
class xet_mem_type_t(xet_mem_prop_type_t):
    pass

###############################################################################
## @brief Data for the property ::XET_MEM_PROP_ECC_CAP
class xe_bool_t(xet_mem_prop_ecc_cap_t):
    pass
...
class xe_bool_t(xet_mem_prop_ecc_clear_t):
    pass

###############################################################################
## @brief Data for the property ::XET_MEM_PROP_ECC_POISON
class xe_bool_t(xet_mem_prop_ecc_poison_t):
    pass
...
class xet_link_type_t(xet_link_prop_type_t):
    pass

###############################################################################
## @brief Data for the property ::XET_LINK_PROP_BUS_ADDRESS
class xet_string_property_t(xet_link_prop_bus_address_t):
    pass

###############################################################################
## @brief Data for the property ::XET_LINK_PROP_PWR_CAP
class xe_bool_t(xet_link_prop_pwr_cap_t):
    pass
...
class uint32_t(xet_link_prop_max_packet_c_size_t):
    pass
...
class uint32_t(xet_link_prop_replay_counter_t):
    pass
...
class xet_sysman_event_data_t(Structure):
    _fields_ = [
        ("hResContainer", xet_res_container_handle_t),                  ## [out] The resource container that generated the event
...
if __use_win_types:
    _xetSysmanGetResourceContainerByUuid_t = WINFUNCTYPE( xe_result_t, xet_sysman_handle_t, xet_res_container_uuid_t, POINTER(xet_res_container_handle_t) )
else:
    _xetSysmanGetResourceContainerByUuid_t = CFUNCTYPE( xe_result_t, xet_sysman_handle_t, xet_res_container_uuid_t, POINTER(xet_res_container_handle_t) )
