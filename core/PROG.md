...
```c
    ...
    xeCommandListAppendWaitOnEvents(hCommandList, 1, &hEvent);
...
```c
    ...
    xeCommandListAppendBarrier(hCommandList);
...
```c
    ...
    xeCommandListAppendMemoryRangesBarrier(hCommandList, 1, &size, &ptr);
