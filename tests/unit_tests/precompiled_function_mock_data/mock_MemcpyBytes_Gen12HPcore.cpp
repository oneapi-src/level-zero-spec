...
static uint32_t MemcpyBytes_SurfaceStateHeap_Gen12HPcore[] = {
    0x87fd4000, 0x04000000, 0x001f007f, 0x00000000, 0x00000000, 0x00000000, 0x00000000,
    0x00000000, 0x862da000, 0x000001b3, 0x00000000, 0x00000000, 0x00000000, 0x00000000,
    0x00000000, 0x00000000, 0x87fd4000, 0x04000000, 0x001f007f, 0x00000000, 0x00000000,
    0x00000000, 0x00000000, 0x00000000, 0x862dc000, 0x000001b3, 0x00000000, 0x00000000,
...
static const uint32_t MemcpyBytes_SamplerArrayDataBase_Gen12HPcore[] = {0xffffffff, 0x0,
                                                                        0xffffffff};
...
static const PrecompiledFunctionMockData MemcpyBytes_Gen12HPcore{
    ...
    MemcpyBytes_ISA_Gen12HPcore,
    sizeof(MemcpyBytes_ISA_Gen12HPcore),
    MemcpyBytes_CrossThreadDataBase_Gen12HPcore,
    sizeof(MemcpyBytes_CrossThreadDataBase_Gen12HPcore),
    MemcpyBytes_PerThreadDataBase_Gen12HPcore,
    sizeof(MemcpyBytes_PerThreadDataBase_Gen12HPcore),
    ...
    MemcpyBytes_BufferArgIndicesAndOffsets_Gen12HPcore,
    sizeof(MemcpyBytes_BufferArgIndicesAndOffsets_Gen12HPcore) /
        sizeof(MemcpyBytes_BufferArgIndicesAndOffsets_Gen12HPcore[0]),
    MemcpyBytes_HasBarriers_Gen12HPcore,
    MemcpyBytes_SlmSize_Gen12HPcore,
    MemcpyBytes_HasPrintfOutput_Gen12HPcore};

RegisterPrecompiledFunctionMocksData Register_MemcpyBytes_Gen12HPcore{&MemcpyBytes_Gen12HPcore,
                                                                      "MemcpyBytes", "Gen12HPcore"};
