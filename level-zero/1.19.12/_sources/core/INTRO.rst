...
driver, which the driver retains ownership of.
  ...
  - The rules above apply to Level Zero object handles. They do not apply to OS-level handles reported by the driver, such as the file descriptor in :ref:`ze-external-memory-export-fd-t`\.
